...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        // Name of the watermark image in plugins/watermark folder add logo
        PluginSettings.Add("Watermark_source", COMMOM.Interface.ISetting.GetSettingValue("SettingBannervi"));
